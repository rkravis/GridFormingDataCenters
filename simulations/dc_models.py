...
from sting.generator import VoltageSource4A, GFMI18A, GFLI13A, GFLI16C, GFLI23A, GFMI25A, VoltageSource5A
...
gfmi_e_dc = GFMI25A(
    ...
    Tload_s = 0.0001, i_load_ref = i_load_ref, 
)
...
gfli_e_dc = GFLI16C(
    ...
    kp_cc_pu=0.05, ki_cc_puHz=0.6, kff_cc=0.75,
    # DC side 
    v_dc_ref=1.05, c_dc_pu=20.0, r_dc_pu=1000, kp_oc_pu=2, ki_oc_puHz=10, Tload_s=0.0001
)
...
def base_system_strong(case_directory, dc_model):
    ...
    line_1 = LinePiModel(
        name="lima_to_santiago", from_bus="lima", to_bus="santiago",
        base_power_MVA=100, base_voltage_kV=230, base_frequency_Hz=60,
        r_pu=0.001, x_pu=0.05, g_pu=0.0005, b_pu=0.001
        )
    ...
    source = VoltageSource5A(
        name="bulk_grid", bus="lima", 
        minimum_active_power_MW=-200, maximum_active_power_MW=200, minimum_reactive_power_MVAR=-100, maximum_reactive_power_MVAR=100,
        cost_variable_USDperMWh=0, base_power_MVA=100, base_voltage_kV=230, base_frequency_Hz=60,
