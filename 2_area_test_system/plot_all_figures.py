...
results_folder = os.path.join(output_dir, 'far_load_step/ssm/')
gfli_a, gfli_e, gfli_d, gfmi_c, gfmi_e, gfli_a_sh, gfli_d_sh, gfli_e_sh, gfmi_c_sh, gfmi_e_sh = read_all_sim_results(results_folder)
...
results_folder = os.path.join(output_dir, "Results/near_gen_step/ssm/")
gfli_a, gfli_e, gfli_d, gfmi_c, gfmi_e, gfli_a_sh, gfli_d_sh, gfli_e_sh, gfmi_c_sh, gfmi_e_sh = read_all_sim_results(results_folder)
...
results_folder = os.path.join(output_dir, "Results/inf_bus_v_step/ssm/")
gfli_a, gfli_e, gfli_d, gfmi_c, gfmi_e, gfli_a_sh, gfli_d_sh, gfli_e_sh, gfmi_c_sh, gfmi_e_sh = read_all_sim_results(results_folder)
...
results_folder = os.path.join(output_dir, "Results/fault_inf_bus/emt/")
gfli_a, gfli_e, gfli_d, gfmi_c, gfmi_e, gfli_a_sh, gfli_d_sh, gfli_e_sh, gfmi_c_sh, gfmi_e_sh = read_all_sim_results(results_folder)
